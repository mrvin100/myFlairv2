  ...
  const handleResponseSubmit = async (reviewId: string) => {
    ...
    try {
      ...
      toast({
        title: "Erreur",
        description:
          "Une erreur est survenue lors de la soumission de votre réponse.",
        variant: "destructive",
      });
    }
  };
                              ...
                              <CardContent className="p-6">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                  ...
                                  <div className="flex flex-col items-end justify-between">
                                    ...
                                    <Link
                                      href={`/back-up/servicePage/${service.id}`}
                                    >
                                ...
                                <div className="flex items-center space-x-4 mb-2">
                                  <Avatar className="w-8 h-8">
                                    {review.professional?.image ? (
                                      ...
                                      <AvatarFallback className="bg-gray-400">
                                        {review.professional?.firstName.charAt(
                                          0
                                        )}
                                        {review.professional?.lastName.charAt(
                                          0
                                        )}
                                      </AvatarFallback>
                                    )}
