              ...
              <AlertDialog>
                ...
                {showDialog && selectedWorkplace && (
                  <AlertDialogContent>
                    ...
                    <div>
                      <label>Titre du poste</label><br /><br />
                      <Input
                        type="text"
                        ...
                        required
                      /><br />
                      <label>Prix durant la semaine</label><br /><br />
                      <Input
                        type="number"
                        value={selectedWorkplace.weekPrice}
                        onChange={(e) => handlePostChange('weekPrice', e.target.value)}
                        required
                      /><br />
                      <label>Prix le samedi</label><br /><br />
                      <Input
                        type="number"
                        value={selectedWorkplace.saturdayPrice}
                        onChange={(e) => handlePostChange('saturdayPrice', e.target.value)}
                        required
                      /><br />
                      <div>
                        ...
                        <div className="flex space-x-2 items-center">
                          ...
                          <Input
                            ...
                            min="0"
                            max="23"
                            value={selectedWorkplace.durationWeekStartHour}
                            onChange={(e) => handlePostChange('durationWeekStartHour', parseInt(e.target.value))}
                            placeholder="HH"
                            required
                          />
                          <span>h</span>
                          <Input
                            ...
                            min="0"
                            max="59"
                            value={selectedWorkplace.durationWeekStartMinute}
                            onChange={(e) => handlePostChange('durationWeekStartMinute', parseInt(e.target.value))}
                            placeholder="MM"
                            required
                          />
                          <span>à</span>
                          <Input
                            ...
                            onChange={(e) => handlePostChange('durationWeekEndHour', parseInt(e.target.value))}
                            placeholder="HH"
                            required
                          />
                          <span>h</span>
                          <Input
                            ...
                            min="0"
                            max="59"
                            value={selectedWorkplace.durationWeekEndMinute}
                            onChange={(e) => handlePostChange('durationWeekEndMinute', parseInt(e.target.value))}
                            placeholder="MM"
                            required
                          />
                        </div>
                      ...
                      <div>
                        <label>Heures d'ouverture le samedi</label><br />
                        <div className="flex space-x-2 items-center">
                          ...
                          <Input
                            ...
                            min="0"
                            max="23"
                            value={selectedWorkplace.durationSaturdayStartHour}
                            onChange={(e) => handlePostChange('durationSaturdayStartHour', parseInt(e.target.value))}
                            placeholder="HH"
                            required
                          />
                          <span>h</span>
                          <Input
                            ...
                            min="0"
                            max="59"
                            value={selectedWorkplace.durationSaturdayStartMinute}
                            onChange={(e) => handlePostChange('durationSaturdayStartMinute', parseInt(e.target.value))}
                            placeholder="MM"
                            required
                          />
                          <span>à</span>
                          <Input
                            ...
                            min="0"
                            max="23"
                            value={selectedWorkplace.durationSaturdayEndHour}
                            onChange={(e) => handlePostChange('durationSaturdayEndHour', parseInt(e.target.value))}
                            placeholder="HH"
                            required
                          />
                          <span>h</span>
                          <Input
                            ...
                            min="0"
                            max="59"
                            value={selectedWorkplace.durationSaturdayEndMinute}
                            onChange={(e) => handlePostChange('durationSaturdayEndMinute', parseInt(e.target.value))}
                            placeholder="MM"
                            required
                          />
                        </div>
                      ...
                      <ReactQuill
                        ...
                        onChange={(value) => handlePostChange('description', value)}
                      />
                      <br />
                      {/* Gestion des images */}
                      ...
                      <label>Image</label>
                        ...
                        >
                          ...
                          <p className="text-sm">Formats pris en charge: JPEG, PNG, JPG, SVG, WebP</p>
                        </div>
