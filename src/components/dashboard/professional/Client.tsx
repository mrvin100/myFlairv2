...
export default function Client({ typeClient = "boutique", index = 0 }) {

  const userId = 'userId-'
  return (

      <div className="bg-white w-full border rounded-sm p-4 max-w-4xl mx-auto ">
        <div>
          <Image
            src={"/nail-salon.webp"}
            height={120}
        ...
        <div className="flex gap-4 items-center flex-wrap justify-end">
          ...
          <Link href={`/dashboard/professional/Client/${userId + ( index )}`}>
